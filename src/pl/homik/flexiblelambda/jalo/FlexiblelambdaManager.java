 ...
 */
package pl.homik.flexiblelambda.jalo;
...
/**
 * This is the extension manager of the Flexiblelambda extension.
 */
public class FlexiblelambdaManager extends GeneratedFlexiblelambdaManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FlexiblelambdaManager.class.getName());
	 ...
	 */
	public static FlexiblelambdaManager getInstance()
	{
		return (FlexiblelambdaManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FlexiblelambdaConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FlexiblelambdaManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FlexiblelambdaManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FlexiblelambdaManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FlexiblelambdaManager called, current tenant: " + getTenant().getTenantID());
		}
	}
